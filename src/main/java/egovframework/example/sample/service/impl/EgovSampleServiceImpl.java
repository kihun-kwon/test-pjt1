...
import egovframework.example.cmmn.EximbayPayment;
...
public class EgovSampleServiceImpl extends EgovAbstractServiceImpl implements EgovSampleService {
	...
	public String callEximbayStatus(Map<String,String> param, HttpServletRequest req, HttpServletResponse res){
		String retVal = "rescode=0001&resmsg=fail";
		if (EximbayService.verify(req, res)){
			if (EximbayService.callEximbayStatus(param)){
				retVal = "rescode=0000&resmsg=Success";
			}
		}
		return retVal;
	}
